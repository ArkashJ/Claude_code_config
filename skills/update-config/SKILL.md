---
name: update-config
description: Safely modify Codex settings, hooks, permissions, or global instructions. Use when editing ~/.Codex/settings.json, hook commands, plugin or permission configuration, or ~/.Codex/AGENTS.md behavior.
---
...
1. Read each target file completely and verify the current Codex schema against official documentation when the format may have changed.
