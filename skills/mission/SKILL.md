...
Execute the /start prompt's instructions first (see prompts/start.md) (preflight, enumeration, working rules — including
...
Then run the mission in phases, fully autonomously. When a phase needs it, run a mapping pass (unfamiliar ground), a feature/QA loop, or an evidence-first review of your own PRs before calling a phase done.
